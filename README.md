...
2. 修改 `install.sh` 文件的203行，将用户名 `Lin1801` 修改为你自己的GitHub用户名。
```
wget https://cdn.jsdelivr.net/gh/Lin1801/XrayR-V2Board/config.yml -O /etc/XrayR/config.yml
```

3. 修改下面链接的用户名 `Lin1801` 为你自己的GitHub用户名，完成配置一键安装脚本命令。
### x86_64
```
bash <(curl -Ls https://cdn.jsdelivr.net/gh/Lin1801/XrayR-V2Board/install.sh)
```
### ARM_64
```
bash <(curl -Ls https://cdn.jsdelivr.net/gh/Lin1801/XrayR-V2Board/install-arm.sh)
```
